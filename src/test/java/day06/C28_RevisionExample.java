...
public class C28_RevisionExample extends DummyRestBaseUrl {
    /*
    Given
 ...
 */
    ...
    public void test() {
        ...
        Object youngestEmployee = json.getList("data.findAll{it.employee_age==" + minmumAge + "}.employee_name").get(0);
